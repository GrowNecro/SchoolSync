...
Semua unduhan berasal langsung dari URL aplikasi, bukan GitHub. Endpoint PHP lama sudah dihapus dan klien versi 2.0.5 menggunakan route Laravel. Installer membuat heartbeat Windows yang berjalan sebagai `SYSTEM` sejak komputer menyala serta klien interaktif saat pengguna login. Untuk menjaga paket Rumahweb Medium dan website lain dalam akun yang sama, heartbeat dikirim setiap 1–2 menit, status dashboard diperbarui setiap menit, komputer dianggap offline setelah 3 menit, pemeriksaan versi dilakukan setiap 10 menit, dan awal proses diberi jeda acak agar request banyak komputer tidak datang bersamaan.
...
Setelah pembaruan ke klien 2.0.5, semua komputer lama yang masih menunggu dan semua instalasi baru otomatis disetujui. Gunakan menu **Komputer & grup** untuk memasukkan perangkat ke grup atau menonaktifkan izin perangkat tertentu. Status setiap perintah dapat dipantau melalui menu **Aktivitas**.
